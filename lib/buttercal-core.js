...
/*#__PURE__*/
function () {
  function AbstractDate(date) {
    _classCallCheck(this, AbstractDate);

    this.date = date;
    this.ts = +new Date((0, _dateFns.startOfDay)(date));
  }
  /**
  ...
  _createClass(AbstractDate, [{
    ...
    key: "lessThan",
    value: function lessThan(_ref2) {
      var ts = _ref2.ts;
      return this.ts < ts;
    }
  }, {
    key: "lessThanEqual",
    value: function lessThanEqual(_ref3) {
      var ts = _ref3.ts;
      return this.ts <= ts;
    }
    /**
    ...
    key: "greaterThan",
    value: function greaterThan(_ref4) {
      var ts = _ref4.ts;
      return this.ts > ts;
    }
  }, {
    key: "greaterThanEqual",
    value: function greaterThanEqual(_ref5) {
      var ts = _ref5.ts;
      return this.ts >= ts;
    }
  }]);
...
/*#__PURE__*/
function () {
  function Day(abstractDate, _ref) {
    var inMonth = _ref.inMonth,
        inFuture = _ref.inFuture,
    ...
    this.isEnd = isEnd;
    this.label = labelTemplate ? labelTemplate(this) : (0, _dateFns.getDate)(this.abstract.date);
    this.events = [];
    this.eventStart = [];
  }
    ...
    value: function setEvents(events) {
      ...
      events.forEach(function (event) {
        ...
        event.rules.forEach(function (rule) {
          if (rule(_this.abstract.ts)) {
            pass = true;
          }
        });

        if (pass) {
          _this.events.push(event.originalEvent);

          if ((_this.abstract.ts - event.originalEvent.start) % (_constants.MS_IN_DAY * event.originalEvent.every) === 0) {
            _this.eventStart.push(event.originalEvent);
          }
        }
      });
    }
...
/***/ "./src/DaySelectionBase/DaySelectionBase.js":
/*!**************************************************!*\
  !*** ./src/DaySelectionBase/DaySelectionBase.js ***!
  \**************************************************/
/*! no static exports found */
...
var DaySelectionBase =
/*#__PURE__*/
function () {
  function DaySelectionBase() {
    _classCallCheck(this, DaySelectionBase);
  }
  /**
  ...
  _createClass(DaySelectionBase, [{
    key: "select",
    value: function select() {}
  }]);

  return DaySelectionBase;
}();

exports.default = DaySelectionBase;
module.exports = exports["default"];

/***/ }),

/***/ "./src/DaySelectionBase/DaySelectionController.js":
/*!********************************************************!*\
  !*** ./src/DaySelectionBase/DaySelectionController.js ***!
  \********************************************************/
/*! no static exports found */
...
var _DaySelectionBase2 = _interopRequireDefault(__webpack_require__(/*! ./DaySelectionBase */ "./src/DaySelectionBase/DaySelectionBase.js"));

var _NoSelection = _interopRequireDefault(__webpack_require__(/*! ./SelectionStates/NoSelection */ "./src/DaySelectionBase/SelectionStates/NoSelection.js"));

var _StartSelected = _interopRequireDefault(__webpack_require__(/*! ./SelectionStates/StartSelected */ "./src/DaySelectionBase/SelectionStates/StartSelected.js"));

var _StartEndSelected = _interopRequireDefault(__webpack_require__(/*! ./SelectionStates/StartEndSelected */ "./src/DaySelectionBase/SelectionStates/StartEndSelected.js"));
...
var DefaultSelectionController =
/*#__PURE__*/
function (_DaySelectionBase) {
  _inherits(DefaultSelectionController, _DaySelectionBase);

  function DefaultSelectionController(start, end) {
    var _this;

    _classCallCheck(this, DefaultSelectionController);

    _this = _possibleConstructorReturn(this, (DefaultSelectionController.__proto__ || Object.getPrototypeOf(DefaultSelectionController)).call(this));

    if (start && end) {
      _this.selectionState = _StartEndSelected.default;
    } else if (start && !end) {
      _this.selectionState = _StartSelected.default;
    } else {
      _this.selectionState = _NoSelection.default;
    }
  ...
  _createClass(DefaultSelectionController, [{
    key: "select",
    value: function select(abstractDate, calendar) {
      this.selectionState.select(abstractDate, calendar, this);
    }
  }]);

  return DefaultSelectionController;
}(_DaySelectionBase2.default);

exports.default = DefaultSelectionController;
module.exports = exports["default"];

/***/ }),

/***/ "./src/DaySelectionBase/SelectionStates/NoSelection.js":
/*!*************************************************************!*\
  !*** ./src/DaySelectionBase/SelectionStates/NoSelection.js ***!
  \*************************************************************/
/*! no static exports found */
...
var _StartSelected = _interopRequireDefault(__webpack_require__(/*! ./StartSelected */ "./src/DaySelectionBase/SelectionStates/StartSelected.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _default = {
  select: function select(selection, calendar, selectionController) {
    calendar.start = selection;
    selectionController.selectionState = _StartSelected.default;
  }
};
...
/***/ "./src/DaySelectionBase/SelectionStates/StartEndSelected.js":
/*!******************************************************************!*\
  !*** ./src/DaySelectionBase/SelectionStates/StartEndSelected.js ***!
  \******************************************************************/
/*! no static exports found */
...
/***/ "./src/DaySelectionBase/SelectionStates/StartSelected.js":
/*!***************************************************************!*\
  !*** ./src/DaySelectionBase/SelectionStates/StartSelected.js ***!
  \***************************************************************/
/*! no static exports found */
...
var _StartEndSelected = _interopRequireDefault(__webpack_require__(/*! ./StartEndSelected */ "./src/DaySelectionBase/SelectionStates/StartEndSelected.js"));
...
var _default = {
  select: function select(selection, calendar, selectionController) {
    ...
    if (selection.greaterThan(start)) {
      ...
      selectionController.selectionState = _StartEndSelected.default;
...
var _AbstractDate = _interopRequireDefault(__webpack_require__(/*! ./AbstractDate */ "./src/AbstractDate.js"));

var _Day = _interopRequireDefault(__webpack_require__(/*! ./Day */ "./src/Day.js"));
...
/*#__PURE__*/
function () {
  function Month(date, _ref) {
    var start = _ref.start,
        end = _ref.end,
        _ref$labelTemplate = _ref.labelTemplate,
        labelTemplate = _ref$labelTemplate === void 0 ? null : _ref$labelTemplate;
  ...
  _createClass(Month, [{
    key: "getDays",
    value: function getDays(labelTemplate) {
      var month = [];
      var monthStart = new _AbstractDate.default(new Date((0, _dateFns.startOfMonth)(this.date)));
      var displayStart = new _AbstractDate.default((0, _dateFns.subDays)(monthStart.date, (0, _dateFns.getDay)(monthStart.date)));
      var monthEnd = new _AbstractDate.default(new Date((0, _dateFns.lastDayOfMonth)(this.date)));

      for (var i = 0; i < 42; i++) {
        var current = new _AbstractDate.default(new Date((0, _dateFns.addDays)(displayStart.date, i)));
        month.push(new _Day.default(current, {
          inMonth: current.greaterThanEqual(monthStart) && current.lessThanEqual(monthEnd),
          inFuture: current.greaterThan(_constants.TODAY),
          isToday: current.equals(_constants.TODAY),
...
exports.MS_IN_DAY = exports.TOMORROW = exports.TODAY = void 0;
...
var TODAY = new _AbstractDate.default(new Date(currentDate));
exports.TODAY = TODAY;
var TOMORROW = new _AbstractDate.default(new Date((0, _dateFns.addDays)(currentDate, 1)));
...
var _Month = _interopRequireDefault(__webpack_require__(/*! ./Month */ "./src/Month.js"));

var _DaySelectionController = _interopRequireDefault(__webpack_require__(/*! ./DaySelectionBase/DaySelectionController */ "./src/DaySelectionBase/DaySelectionController.js"));
...
function () {
  function Calendar() {
    ...
    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {
      monthsToShow: 1,
      defaultStart: _constants.TODAY.date,
      defaultEnd: _constants.TOMORROW.date,
      labelTemplate: null
    },
        _ref$monthsToShow = _ref.monthsToShow,
        monthsToShow = _ref$monthsToShow === void 0 ? 1 : _ref$monthsToShow,
        _ref$defaultStart = _ref.defaultStart,
        defaultStart = _ref$defaultStart === void 0 ? _constants.TODAY.date : _ref$defaultStart,
        _ref$defaultEnd = _ref.defaultEnd,
        defaultEnd = _ref$defaultEnd === void 0 ? _constants.TOMORROW.date : _ref$defaultEnd,
        _ref$labelTemplate = _ref.labelTemplate,
        labelTemplate = _ref$labelTemplate === void 0 ? null : _ref$labelTemplate;
    ...
    this.renderedMonths = [];
    this.start = defaultStart ? new _AbstractDate.default(defaultStart) : null;
    this.end = defaultEnd ? new _AbstractDate.default(defaultEnd) : null;
    this.observers = {
      selectionChanged: [],
      monthChanged: []
    };
    this.labelTemplate = labelTemplate;
    this.daySelector = new _DaySelectionController.default(this.start, this.end);
    this.today = _constants.TODAY;
    this.tomorrow = _constants.TOMORROW;
    this.setMonths(date);
    this.events = [];
  }
  ...
  _createClass(Calendar, [{
    ...
    value: function nextMonth() {
      this.renderedMonths = [].concat(_toConsumableArray(this.renderedMonths.slice(1)), [new _Month.default(new Date((0, _dateFns.addMonths)(this.renderedMonths[this.renderedMonths.length - 1].date, 1)), {
        start: this.start,
        end: this.end,
    ...
    value: function prevMonth() {
      this.renderedMonths = [new _Month.default(new Date((0, _dateFns.subMonths)(this.renderedMonths[0].date, 1)), {
        start: this.start,
        end: this.end,
        labelTemplate: this.labelTemplate
      })].concat(_toConsumableArray(this.renderedMonths.slice(0, -1)));
      this.notifyObservers('monthChanged', {
        months: this.renderedMonths,
        type: 'prev'
      });
    ...
    key: "setMonths",
    value: function setMonths(date) {
      var monthsToShow = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.monthsToShow;
      this.renderedMonths = [new _Month.default(new Date((0, _dateFns.subMonths)(date, 1)), {
        start: this.start,
        end: this.end,
        labelTemplate: this.labelTemplate
      }), new _Month.default(new Date(date), {
        start: this.start,
        end: this.end,
        labelTemplate: this.labelTemplate
      })];
      ...
      for (var i = 0; i < monthsToShow; i++) {
        this.renderedMonths.push(new _Month.default(new Date((0, _dateFns.addMonths)(date, i + 1)), {
          start: this.start,
          end: this.end,
          labelTemplate: this.labelTemplate
        }));
    ...
    key: "addCalEvent",
    value: function addCalEvent(event) {
      ...
      event.start = +new Date((0, _dateFns.startOfDay)(event.start));
      event.end = +new Date((0, _dateFns.startOfDay)(event.end));
      event.duration = (event.end - event.start) / _constants.MS_IN_DAY + 1;
      var rules = [function (ts) {
        return ts >= event.start && ts <= event.end;
      }];

      if (event.every) {
        rules.push(function (ts) {
          return (ts - event.start) % (_constants.MS_IN_DAY * event.every) >= 0 && (ts - event.start) % (_constants.MS_IN_DAY * event.every) <= event.end - event.start;
        });
      }
    ...
    key: "addCalEvents",
    value: function addCalEvents(events) {
      var _this = this;

      events.forEach(function (event) {
        _this.addCalEvent(event);
      });
      this.updateEvents();
    }
  }, {
    ...
    value: function updateEvents() {
      ...
      this.renderedMonths.forEach(function (month) {
        month.days.forEach(function (day) {
          day.setEvents(_this2.events);
        });
      });
    }
    /**
    ...
    key: "selectDay",
    value: function selectDay(abstractDate) {
    ...
    key: "notifyObservers",
    value: function notifyObservers(type, data) {
      if (this.observers.hasOwnProperty(type)) {
        this.observers[type].forEach(function (updateFunction) {
          updateFunction(data);
        });
      }
    }
    ...
    key: "subscribe",
    value: function subscribe(type, subscriber) {
      if (this.observers.hasOwnProperty(type)) {
    ...
    key: "getAbstractDate",
    value: function getAbstractDate(date) {
      return new _AbstractDate.default(date);
    }
  }]);
...
//# sourceMappingURL=buttercal-core.js.map